    ...
    <>
      ...
      >
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden relative z-[1002] w-10 h-10 flex flex-col justify-center items-center"
      ...
      {/* Separate Mobile Menu Overlay - Completely rebuilt with solid background */}
      {isMobileMenuOpen && (
        <div 
          className="md:hidden fixed inset-0 z-[1001] overflow-hidden"
          style={{
            position: 'fixed',
            top: 0,
            left: 0,
        ...
        >
          <div 
            className="dark:hidden fixed inset-0"
            style={{
              position: 'fixed',
              top: 0,
              left: 0,
          ...
          ></div>
          <div 
            className="hidden dark:block fixed inset-0"
            style={{
              position: 'fixed',
              top: 0,
              left: 0,
